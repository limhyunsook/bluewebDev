            ...
            <li class="col-xs-4">
                <div class="col-m-3">
                    ...
                    <div class="row-m-2">
                        ...
                        <p>ns5.blueweb.co.kr<Br/><span>210.205.6.9</span></p>
                    </div>	
                </div>	
            </li>
        </ul>   
         ...
         <ul class="row">
            <li class="col-xs-4">              
                <div class="col-xe-1">                  
                    ...
                    <a href="#">+</a>
                    <ul>					
                        <li><a>6월 카드 무이자 행사 안내 <span>N</span></a><span>2016.5.12</span></li>
                        <li><a>세금계산서 신청 2016년 7월15일 마감안내</a><span>2016.5.12</span></li>
                        <li><a>오픈몰 서버 점검 안내 (6/28)</a><span>2016.5.12</span></li>
                    </ul>                  		
                </div>
            </li>
           <li class="col-xs-4">                 
                <div class="col-xe-2">                   
                    ...
                    <div>	
                        <p>1588-2120</p>
                        <span>평일 9시~6시/점심시간 12시~1시</span>                   		
                    </div>    
                </div>
            </li>
            <li class="col-xs-4">
