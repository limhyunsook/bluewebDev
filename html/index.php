					...
					<div>
						...
						<span>
							<select>
								...
								<option value="saab">.net</option>
								<option value="mercedes">.org</option>
								<option value="audi">.biz</option>
								<option value="audi">.info</option>
								<option value="audi">.name</option>
								<option value="audi">.co.kr</option>
								<option value="audi">.kr</option>
								<option value="audi">.or.kr</option>
							</select>										
						</span>	
					</div>
					<ul>
