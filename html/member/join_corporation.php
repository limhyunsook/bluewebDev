...
<section class="join-warp">	
	<div class="form-join">
		...
		<!-- form-->
		<div class="form-type">		
			<h2><span>법인사업자</span> 회원가입</h2>
			
			<div class="frm-input">	
				<input type="text" value="" placeholder="사업자번호" class="input-style01">
			...
			<div class="frm-input">
				<input type="text" value="" placeholder="기업명" class="input-style02">
				<div class="tooltip">6~12를 이내 영문과 숫자 조합(대소문자 구별)</div>
			</div>

			<div class="frm-input">
				<input type="text" value="" placeholder="대표자명" class="input-style02">
				<div class="tooltip">6~12를 이내 영문과 숫자 조합(대소문자 구별)</div>
			</div>

			<div class="frm-input">
				<input type="text" value="" placeholder="담당자명" class="input-style02">
				<div class="tooltip">6~12를 이내 영문과 숫자 조합(대소문자 구별)</div>
			</div>
			...
			<div class="frm-input">
				...
				<input type="checkbox" value="" name="checkbox" checked="" id="ddd" class="checkbox-style02"><label for="ddd" class="label-style01"> 이메일 수신 여부</label>							
			</div>
