...
<!--==========  find_dormancy_ok ==========-->
<section class="find-dormancy-ok-warp">	


	<div class="find-dormancy-ok-box">

			<i class="fa fa-check"></i>
			<h2>휴면 계정 복원이<Br/>완료되었습니다</h2>
			<p><span>블루웹 서비스</span>를 다시 이용하실 수 있습니다.</p>
			<button class="find-dormancy-ok-btn" onclick="location.href='/html/index.php';">확인</button>
	</div>	
	

</section>
<!--========== end find_dormancy_ok ==========-->
