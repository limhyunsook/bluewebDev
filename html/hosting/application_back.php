    ...
    <div class="blu-content wrapper">        
        <div role="tabpanel">
            ...
            <div class="tab-content fixing">
                ...
                <div role="tabpanel" class="tab-pane active" id="step01"> 
                    <ul class="row">
                        <li class="col-xs-9 list">
                            ...
                            <caption class="table_title">호스팅 기본 정보 선택</caption>       
                            <tbody>
                                 <tr>
                                    <th>호스팅 종류</th>
                                    <td>     
                                ...
                                <tr class="table-success">
                                    ...
                                    <td>    
                                        ...
                                        <a href="#" class="btn btn-danger">선납무이자</a>
                                    </td>
                                 </tr>   
                            </tbody>
                            </table>    
                            
                            <div class="tip">* 호스팅 견적을 메일로 받아 보실 수 있습니다.</div>
                ...
                <div role="tabpanel" class="tab-pane" id="step02">
                    ...
                    <table class="table tableTypeA ma2">       
                    <caption class="table_title">회원 정보</caption>   
                    <tbody>
                         <tr>
                            <th>이름</th>
                        ...
                        <tr class="table-success">
                            <th>전화번호</th>
                            <td><input type="text" class="form-control phone" maxlength="11"  placeholder="Telephone"></td>
                        </tr>  
                        <tr class="table-success">
                            <th>휴대 전화번호</th>
                            <td><input type="text" class="form-control phone" maxlength="11"  placeholder="Telephone"></td>
                    ...
                    <table class="table tableTypeA ma2">
                    <caption class="table_title">호스팅 관리자 정보
                    ...
                    <tbody>
                        ...
                        <tr class="table-success">
                            <th>전화번호</th>
                            <td>
                                <input type="text" class="form-control phone" maxlength="11"  placeholder="Telephone">
                                <span class="color02 ma0">(- 포함시켜주세요)</span>                        
                            </td>
                        <tr class="table-success">
                            <th>휴대 전화번호</th>
                            <td>
                    ...
                    <table class="table tableTypeA ma2">
                    <caption class="table_title">FTP정보</caption>
                    <tbody>
                        <tr>
                            <th>도메인</th>
                            <td><input type="text" class="form-control" placeholder="Domain"></td>
                        </tr>
                        <tr class="table-success">
                        ...
                        <tr class="table-success">
                            ...
                            <td>
                                ...
                                <span class="color02 ma0">※ FTP비밀번호는 도메인명, FTP ID와 동일하게 설정할 수 없으며,8자 이상으로 작성하셔야 합니다.</span>   
                            </td>
                        </tr>  
                        <tr class="table-success">
                            <th>FTP 비밀번호 확인</th>
                    ...
                    <table class="table tableTypeA ma2">
                    <caption class="table_title">APM 정보</caption>
                    <tbody>
                        <tr>
                            <th>PHP종류 선택</th>
                            <td>  
                        ...
                        <tr class="table-success">
                            <th>DB 아이디</th>
                            <td><input type="text" class="form-control" placeholder="DB Id"></td>
                        </tr>  
                        <tr class="table-success">
                            <th>DB 비밀번호</th>
                            <td><input type="text" class="form-control" placeholder="DB Password"></td>
                        </tr>                     
                    </tbody>
                    </table>  
                    ...
                    <table class="table tableTypeA ma2">
                    <caption class="table_title">파트너 정보 확인</caption>
                    <tbody>
                        <tr>
                            <th>파트너 ID</th>
                            <td>
                    ...
                    <div class="tip">-  파트너 ID를 알고계신 고객께서는 파트너 ID를 입력후 반드시 '파트너정보확인' 버튼을 클릭하여 인증을 받기 바랍니다.</div>    
                ...
                <div role="tabpanel" class="tab-pane" id="step03">  
                    ...
                    <caption class="table_title">                   
                        호스팅 기본 정보
                        <button type="button" id="tabStep02" class="btn btn-danger btn_xs">호스팅 기본정보 수정</button>                        
                    </caption>                             
                    <tbody>
                        <tr>
                            <th>호스팅 종류</th>
                            <td><input type="text" class="form-control" placeholder="Kinds"></td>
                        </tr>
                        <tr class="table-success">
                            <th scope="row">호스팅 사양</th>
                            <td><input type="text" class="form-control" placeholder="Specifications"></td>
                        </tr>  
                        <tr class="table-success">
                            <th>메일 형태</th>
                            <td><input type="text" class="form-control" placeholder="Mail"></td>
                        </tr>  
                        <tr class="table-success">
                            <th>요금납부 방식</th>
                            <td><input type="text" class="form-control" placeholder="Payment"></td>
                        </tr>  
                         <tr class="table-success">
                            <th>혜택</th>
                            <td><input type="text" class="form-control" placeholder="Benefits"></td>
                        </tr>  
                         <tr class="table-success">
                            <th>보안서비스</th>
                            <td><input type="text" class="form-control" placeholder="Security Service"></td>
                        </tr>  
                    </tbody>
                    </table>   
                    ...
                    <caption class="table_title">                   
                        호스팅 관리자 정보
                        <button type="button" id="tabStep02" class="btn btn-danger btn_xs">호스팅 관리자정보 수정</button> 
                    </caption>                             
                    <tbody>
                        <tr>
                            <th>이름</th>
                    ...
                    <caption class="table_title">                   
                        요금 담당자 정보
                        <button type="button" id="tabStep02" class="btn btn-danger btn_xs">호스팅 요금 담당자 정보 수정</button>  
                    </caption>                             
                    <tbody>
                        <tr>
                            <th>이름</th>
                    ...
                    <table class="table tableTypeA ma2">
                    <caption class="table_title">약관 동의</caption>                             
                    <tbody>
                        <tr>
                            <th>호스팅 이용약관 동의</th>
                            <td>     
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>  
                                ...
                                <a href="#" class="btn btn-danger ma0">쿠폰조회</a>
                            </td>
                        </tr>  
                        <tr>
                            <th>예치금</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="radiocontainer">
                                    <input type="radio" name="inlineRadioOptions4" id="inlineRadio1" value="option1">
                                    <span class="radio-text"></span> 개인소득공제용 
                                </label>
                                <label class="radiocontainer">
                                    <input type="radio" name="inlineRadioOptions4" id="inlineRadio1" value="option1">
                                    <span class="radio-text"></span> 사업자증빙용 
                                </label>  
                                <div class="cart_billnum ma0">
                                    <label for="phone_num" class="control-label">전화번호:</label>
                                    <input type="text" class="form-control phone" maxlength="11"  placeholder="Telephone">
                                </div>
                                <div class="cart_billnum ma0">
                                    <label for="phone_num" class="control-label">사업자 등록 번호:</label>
                                    <input type="text" class="form-control phone" maxlength="11"  placeholder="Telephone">
                                </div>
                            </td>
                        </tr> 
                        <tr>
                            <th>세금계산서 정보선택</th>
                            <td>
                                <a href="#" class="btn btn-danger ma0">세금계산서 목록</a>
                            </td>
                        </tr>
                        <tr>
                            <th>사업자 등록</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-danger ma0">우편번호</a>
                            </td>
                        </tr>
                        <tr>
                            <th>사업장 소재지</th>
                            <td>
                                <input type="text" class="form-control" placeholder="Business Place">
                            </td>
                        </tr>
                        <tr>
                            <th>업태</th>
                        ...
                        <tr>
                            <th>업종</th>
                            <td>
                                <input type="text" class="form-control" placeholder="Sectors">
                            </td>
                        </tr>
                        <tr>
                            <th>담당자명</th>
                ...
                <div role="tabpanel" class="tab-pane" id="step04">                  
                    ...
                    <tbody>
                        ...
                        <tr class="table-success">
                            ...
                            <td><input type="text" class="form-control" placeholder="Order Number"></td>
                        </tr>  
                        <tr class="table-success">
                            <th>에러메시지</th>
                            <td><input type="text" class="form-control" placeholder="Error message"></td>
                        </tr>  
                        <tr class="table-success">
                            <th>결제내역(원)</th>
                            <td><input type="text" class="form-control" placeholder="Payment"></td>
        ...
        <div class="cart">
            ...
            <div class="btnBox">
                ...
                <button type="button" id="tabStep01" class="btn btn-warning ma1" onclick="tabNextStep();">
                    이전단계 <span class="lnr lnr-chevron-right"></span>
                </button>           
